...
lazy val root = (project in file(".")).
  ...
  settings(
    ...
    description := "Html-to-json API bindings for Scala.js",
    version := apiVersion,
    ...
    libraryDependencies ++= Seq(
      ...
      "io.scalajs.npm" %%% "request" % "2.79.0-2"
    ))
...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/ldaniels528/scalajs-node-npm</url>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/html-to-json.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/html-to-json.git</developerConnection>
        <url>github.com/scalajs-io/html-to-json.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
